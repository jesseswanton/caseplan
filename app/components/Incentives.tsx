...
const IncentivesTab: React.FC = () => {
  ...
  const loadSavedNotes = () => {
    const savedNotes = JSON.parse(localStorage.getItem("incentivesNotes") || "[]");
    return savedNotes;
  };

  // Save notes to localStorage whenever notes change
  const saveNotesToLocalStorage = (newNotes: string[]) => {
    localStorage.setItem("incentivesNotes", JSON.stringify(newNotes));
  };
    ...
    <div className="mt-3">
      ...
      <div className="mb-3">
        <Form.Control
          ...
          placeholder="Add an incentive note"
        />
      </div>
